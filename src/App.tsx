...
function App() {
  ...
  const [charLenght,setLenght]=useState<number>(0)
      ...
      <section className="grid place-content-center min-h-screen bg-[hsl(248,15%,11%)] font-JetBrains">
        ...
        <article className="min-h-[400px] w-[90vw] bg-[hsl(248,10%,15%)] text-[hsl(252,11%,91%)] p-4 flex flex-col justify-between gap-5 md:w-[40vw] lg:w-[27vw]">
          ...
          <div className="flex justify-between items-center">
            ...
            <h1 className="font-bold text-2xl text-green-300">{charLenght}</h1>
          </div>
          <div>
            <input 
            value={charLenght}
          ...
          <div>
            <ul className="flex flex-col gap-2">
              <li><input className="check" id="upperCase" type="checkbox" /><label htmlFor="upperCase">Include UpperCase Letters</label></li>
              <li><input className="check" id="LowerCase" type="checkbox" /><label htmlFor="">Include Lowercase letters</label></li>
              <li><input className="check" id="Numbers" type="checkbox" /><label htmlFor="Numbers">Include Numbers</label></li>
              <li><input className="check" id="Symbols" type="checkbox" /><label htmlFor="Symbols">Include Symbols</label></li>
            </ul>
          </div>
